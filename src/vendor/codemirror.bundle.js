(() => {
  ...
  // src/editor/codemirror-entry.js
  var editableTheme = EditorView.theme({
    "&": {
      height: "100%",
      minHeight: "260px",
  ...
  var syntaxTheme = HighlightStyle.define([
  ...
  function languageExtension(language2) {
    if (language2 === "javascript") return [javascript()];
    ...
    create(options) {
      ...
      return {
        ...
        setLanguage(language2) {
          view.dispatch({
            effects: languageConf.reconfigure(languageExtension(language2))
          });
        },
        format() {
